...
#define GIMBAL_CAN								hcan1		//which can bus device mount
...
#define BT_HUART									huart2	//for debug use
	...
	#define CV_HUART									huart6	//connected to manifold9
#else
...
#define GIMBAL_RC_MOVE_RATIO_YAW			0.5f		//biger = move faster, 1.0f = 100%

#define GIMBAL_PC_MOVE_RATIO_PIT			0.2f		//biger = move faster, 1.0f = 100%
#define GIMBAL_PC_MOVE_RATIO_YAW			0.8f		//biger = move faster, 1.0f = 100%
/*================ GIMBAL MOVE SPEED RATIO ==================*/


/*================ GIMBAL MOVE POSITION LIMIT ==================*/
#define YAW_MOVE_RANGE	 700 	//from center(aka.0)， also = [center-RANGE, center+RANGE], total = 8192
//#define PIT_MOVE_UP		 	 500
//#define PIT_MOVE_DOWN		 1000  
/*================ GIMBAL MOVE POSITION LIMIT ==================*/


/*================ GIMBAL SHOT PART PARAM ==================*/
//#define POKE_MOTOR_SPEED							500	//biger = faster  SLL:原2300
#define SHOT_FRIC_WHEEL_SPEED					1200		//biger = faster, max = 2000  min=1000c
/*================ GIMBAL SHOT PART PARAM ==================*/
