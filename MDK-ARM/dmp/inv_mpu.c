...
u8 run_self_test(void)
{
	...
	/*这里用了直接写入偏移值，免去上电校准的恼火*/
	gyro[0] = -312124; gyro[1] = 15386; gyro[2]= 2838;
	accel[0] = -677; accel[1] = 161; accel[2] = 4497;
//////////////////////////////////////////////
	if (result == 0x3) 							
////////////////////////////////////////////
	{
...
//	if(dmp_read_fifo(gyro, accel, quat, &sensor_timestamp, &sensors,&more))return 1;	 
	if(dmp_read_fifo(gMpuGyro, gMpuAcce, quat, &sensor_timestamp, &sensors,&more))return 1;	 
